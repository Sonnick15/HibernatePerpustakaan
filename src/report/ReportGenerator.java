...
public class ReportGenerator{
    ...
    public static void generateReport() {
        ...
        try {
            System.out.println("===========================================");
            System.out.println("GENERATE LAPORAN BUKU PERPUSTAKAAN");
            System.out.println("===========================================");
            
            System.out.println("1. Memuat data buku dari database...");
            @SuppressWarnings("unchecked")
            List<Buku> listBuku = session.createQuery("FROM Buku").list();
            
            System.out.println("   Data berhasil dimuat: " + listBuku.size() + " records");
            ...
            String reportPath = "reports/LaporanPerpustakaan.jrxml";
            ...
            JRBeanCollectionDataSource dataSource = new JRBeanCollectionDataSource(listBuku);
            ...
            viewer.setTitle("Laporan Data Buku Perpustakaan");
    ...
    public static void exportToPDF(String outputPath) {
        ...
        try {
            System.out.println("===========================================");
            System.out.println("EXPORT LAPORAN PERPUSTAKAAN KE PDF");
            System.out.println("===========================================");
